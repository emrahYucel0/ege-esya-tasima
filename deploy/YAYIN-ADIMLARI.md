...
| Ne | Nereye | Not |
|---|---|---|
| `.output/` (tamamı) | `/home/<CPANEL_USER>/nakliye/.output` | 22 MB |
| `deploy/.htaccess` | `public_html/.htaccess` | Passenger bloğunun ALTINA eklenecek |
| `yuklemeler/` | `/home/<CPANEL_USER>/yuklemeler` | panelden yüklenen görseller |
| `scripts/yedekle.mjs` | `/home/<CPANEL_USER>/nakliye/scripts/` | yalnızca yedek cron'u için |
...
İçindeki `/home/<CPANEL_USER>/yuklemeler` yolundaki `<CPANEL_USER>`, veritabanı
