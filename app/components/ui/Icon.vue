...
const paths = {
  ...
  // Tuş noktaları `h.01` ile çiziliyor — `info` ikonundaki desenin aynısı;
  // yuvarlak uçlu çizgi ayarı sayesinde nokta olarak görünüyorlar.
  calculator:
    'M6 3.2h12a1.4 1.4 0 0 1 1.4 1.4v14.8a1.4 1.4 0 0 1-1.4 1.4H6a1.4 1.4 0 0 1-1.4-1.4V4.6A1.4 1.4 0 0 1 6 3.2ZM8 6.6h8v3.2H8V6.6ZM8.2 13.4h.01M12 13.4h.01M15.8 13.4h.01M8.2 17h.01M12 17h.01M15.8 17h.01',
