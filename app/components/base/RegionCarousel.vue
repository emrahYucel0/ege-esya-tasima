          ...
          >
            ...
            >
              <NuxtImg
                ...
                :alt="region.imageAlt?.trim() || region.title"
                :title="region.title"
              />
              <div class="p-6">
                <!--
                  aria-label KALDIRILDI — bkz. PostCarousel.vue'daki aynı not.
                  Görünen "Kadıköy Nakliyat", etiket "Kadıköy Evden Eve Nakliyat
                  bölgesi için detaylar" diyordu; görünen metin etiketin içinde
                  bitişik olarak geçmediği için sesle kontrol eşleşmiyordu.
                  Görünen ad zaten yeterli.
                -->
                <NuxtLink
                  :to="`/${region.slug}`"
                ...
                >
                  {{ (region.subtitle || region.title) + " Nakliyat" }}
                </NuxtLink>
              </div>
            </div>
          </div>
