      ...
      <div class="space-y-4">
        ...
        >
          <div class="flex justify-between items-start mb-2">
            ...
            <button type="button" @click="removeStep(index)" class="text-white bg-red-500 hover:bg-red-600 rounded-full w-8 h-8 flex items-center justify-center transition duration-150">
